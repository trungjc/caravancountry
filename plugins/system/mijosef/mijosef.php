...
class plgSystemMijosef extends JPlugin {
	...
	public function onAfterInitialise() {
		...
		if (is_object($this->MijosefConfig) and $this->MijosefConfig->multilang == 1) {
			JFactory::getApplication()->menu_associations = 1;
            JFactory::getApplication()->item_associations = 1;
		}
