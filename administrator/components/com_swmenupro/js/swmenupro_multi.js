...
function do_sub_font_extra(){
	tfe=document.getElementById('levelx_sub_font_extra').value;

	switch (tfe){
		case "italic":
		    jQuery('.sub_preview.levelx').css('font-style',tfe);
			jQuery('.sub_preview.levelx').css('text-decoration','none');
			jQuery('.sub_preview.levelx').css('text-transform','none');
			break;
		case "oblique":
			jQuery('.sub_preview.levelx').css('font-style',tfe);
			jQuery('.sub_preview.levelx').css('text-decoration','none');
			...
			break;
		case "line-through":
			jQuery('.sub_preview.levelx').css('text-decoration',tfe);
		    jQuery('.sub_preview.levelx').css('font-style','normal');
			jQuery('.sub_preview.levelx').css('text-transform','none');
			break;
		case "underline":
			jQuery('.sub_preview.levelx').css('text-decoration',tfe);
		...
		case "overline":
			...
			break;
		case "capitalize":
		    jQuery('.sub_preview.levelx').css('text-transform',tfe);
		    jQuery('.sub_preview.levelx').css('font-style','normal');
			jQuery('.sub_preview.levelx').css('text-decoration','none');
			break;
		case "uppercase":
	...
	switch (tfe){
		case "italic":
		    jQuery('.sub_preview.level1').css('font-style',tfe);
			jQuery('.sub_preview.level1').css('text-decoration','none');
			jQuery('.sub_preview.level1').css('text-transform','none');
			break;
		case "oblique":
			jQuery('.sub_preview.level1').css('font-style',tfe);
			jQuery('.sub_preview.level1').css('text-decoration','none');
			...
			break;
		case "line-through":
			jQuery('.sub_preview.level1').css('text-decoration',tfe);
		    jQuery('.sub_preview.level1').css('font-style','normal');
			jQuery('.sub_preview.level1').css('text-transform','none');
			break;
		case "underline":
			jQuery('.sub_preview.level1').css('text-decoration',tfe);
		...
		case "overline":
			...
			break;
		case "capitalize":
		    jQuery('.sub_preview.level1').css('text-transform',tfe);
		    jQuery('.sub_preview.level1').css('font-style','normal');
			jQuery('.sub_preview.level1').css('text-decoration','none');
			break;
		case "uppercase":
...
jQuery('.sub_preview.level1').css('padding',padtop+'px '+padright+'px '+padbottom+'px '+padleft+'px ');


var padtop2 = trim(document.getElementById('levelx_sub_pad_top').value);
var padright2 = trim(document.getElementById('levelx_sub_pad_right').value);
var padbottom2 = trim(document.getElementById('levelx_sub_pad_bottom').value);
var padleft2 = trim(document.getElementById('levelx_sub_pad_left').value);

//document.getElementById('sub_padding2').value = padtop2+'px '+padright2+'px '+padbottom2+'px '+padleft2+'px ';
jQuery('.sub_preview.levelx').css('padding',padtop2+'px '+padright2+'px '+padbottom2+'px '+padleft2+'px ');
...
function doLevelxBorder(){
var mainwidth = trim(document.getElementById('levelx_outside_border_width').value);
var mainstyle = trim(document.getElementById('levelx_outside_border_style').value);
var maincolor = trim(document.getElementById('levelx_outside_border_color').value);


	t_border=(document.getElementById('xot_border').checked?true:false);
	r_border=(document.getElementById('xor_border').checked?true:false);
	b_border=(document.getElementById('xob_border').checked?true:false);
	l_border=(document.getElementById('xol_border').checked?true:false);

//document.getElementById('main_border').value = mainwidth+'px '+mainstyle+' '+maincolor;
if(document.getElementById('x_corner_style').value!='none'){
do_levelx_corner();
}else if(document.getElementById('menustyle').value=='columnmenu'){
 if(t_border){
jQuery('.levelx_outer').css('border-top',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('.levelx_outer').css('border-top','none');
}
if(r_border){
jQuery('.levelx_outer').css('border-right',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('.levelx_outer').css('border-right','none');
}
if(b_border){
jQuery('.levelx_outer').css('border-bottom',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('.levelx_outer').css('border-bottom','none');
}
if(l_border){
jQuery('.levelx_outer').css('border-left',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('.levelx_outer').css('border-left','none');
}   
    
}else{
if(t_border){
jQuery('#levelx_preview_outer').css('border-top',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('#levelx_preview_outer').css('border-top','none');
}
if(r_border){
jQuery('#levelx_preview_outer').css('border-right',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('#levelx_preview_outer').css('border-right','none');
}
if(b_border){
jQuery('#levelx_preview_outer').css('border-bottom',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('#levelx_preview_outer').css('border-bottom','none');
}
if(l_border){
jQuery('#levelx_preview_outer').css('border-left',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('#levelx_preview_outer').css('border-left','none');
}
}
var mainwidth = trim(document.getElementById('levelx_inside_border_width').value);
var mainstyle = trim(document.getElementById('levelx_inside_border_style').value);
var maincolor = trim(document.getElementById('levelx_inside_border_color').value);

t_border=(document.getElementById('xit_border').checked?true:false);
	r_border=(document.getElementById('xir_border').checked?true:false);
	b_border=(document.getElementById('xib_border').checked?true:false);
	l_border=(document.getElementById('xil_border').checked?true:false);
	auto_border=(document.getElementById('x_auto_border').checked?true:false);

if(auto_border){

document.getElementById('xit_border').checked=true;
document.getElementById('xir_border').checked=true;
document.getElementById('xib_border').checked=true;
document.getElementById('xil_border').checked=true;
t_border=true;
r_border=true;
b_border=false;
l_border=true;
...
if(document.getElementById('xi_corner_style').value=='none'){
//alert(t_border);
if(t_border){
jQuery('.sub_preview.levelx').css('border-top',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('.sub_preview.levelx').css('border-top','none');
}
if(r_border){
jQuery('.sub_preview.levelx').css('border-right',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('.sub_preview.levelx').css('border-right','none');
}
if(b_border){
jQuery('.sub_preview.levelx').css('border-bottom',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('.sub_preview.levelx').css('border-bottom','none');
}
if(l_border){
jQuery('.sub_preview.levelx').css('border-left',mainwidth+'px '+mainstyle+' '+maincolor);
}else{
jQuery('.sub_preview.levelx').css('border-left','none');
}

if(auto_border){
jQuery('.sub_preview.levelx.last').css('border-bottom',mainwidth+'px '+mainstyle+' '+maincolor);
}


}else{
	
do_levelx_inside_corner();
}
//doTopMargin();
}
...
function jInsertEditorText(imagetext,ts){
                   ...
                   document.getElementById('defaultfolder').value=folder;
					...
					}else if(field2.id=='levelx_sub_back_image'){
					field = document.getElementById(ts+'_box');
                    field2 = document.getElementById(ts);
					field.style.background = "url(../" + filename + ")"; 
                    field2.value =  filename;
					jQuery('.sub_preview.levelx.normal').css('background-image','url(../'+filename+')');
					jQuery('#levelx_sub_table').css('background-image','url(../'+document.getElementById('levelx_sub_back_image').value+')');
					}else if(field2.id=='levelx_sub_back_image_over'){
					field = document.getElementById(ts+'_box');
                    field2 = document.getElementById(ts);
					field.style.background = "url(../" + filename + ")"; 
                    field2.value =  filename;
					jQuery('.sub_preview.levelx.hover').css('background-image','url(../'+filename+')');
					...
					}else if(field2.id=='sub_active_background_image'){
					field = document.getElementById(ts+'_box');
                    field2 = document.getElementById(ts);
					field.style.background = "url(../" + filename + ")"; 
                    field2.value =  filename;
					jQuery('.sub_preview.level1.active').css('background-image','url(../'+filename+')');
...
function doFontColor(el){
	...
	if(el.id=="main_font_color"){
		...
		jQuery('.sub_preview.level1.normal').css('color',el.value);
    	if(document.getElementById( "sub_ttf" ).value!=''){
		    ...
		    Cufon.replace('.sub_preview.level1.normal',{fontFamily:str,fontColor:col});
		}
	}else if(el.id=="sub_font_color_over"){
		jQuery('.sub_preview.level1.hover').css('color',el.value);
    	if(document.getElementById( "sub_ttf" ).value!=''){
			var col=document.getElementById('sub_font_color_over').value;
			var str=jQuery('#sub_ttf option:selected').text();
		    Cufon.replace('.sub_preview.level1.hover',{fontFamily:str,fontColor:col});
		}
	}else if(el.id=="levelx_sub_font_color"){
		jQuery('.sub_preview.levelx.normal').css('color',el.value);
    	if(document.getElementById( "levelx_sub_ttf" ).value!=''){
			var col=document.getElementById('levelx_sub_font_color').value;
			var str=jQuery('#levelx_sub_ttf option:selected').text();
		    Cufon.replace('.sub_preview.levelx.normal',{fontFamily:str,fontColor:col});
		}
	}else if(el.id=="levelx_sub_font_color_over"){
		jQuery('.sub_preview.levelx.hover').css('color',el.value);
    	if(document.getElementById( "levelx_sub_ttf" ).value!=''){
			var col=document.getElementById('levelx_sub_font_color_over').value;
			var str=jQuery('#levelx_sub_ttf option:selected').text();
		    Cufon.replace('.sub_preview.levelx.hover',{fontFamily:str,fontColor:col});
		}
	...
	}else if(el.id=="sub_active_font"){
		jQuery('.sub_preview.level1.active').css('color',el.value);
    	if(document.getElementById( "sub_ttf" ).value!=''){
			var col=document.getElementById('sub_active_font').value;
			var str=jQuery('#sub_ttf option:selected').text();
		    Cufon.replace('.sub_preview.level1.active',{fontFamily:str,fontColor:col});
		}
	}
...
function do_sub_corner(){
	...
	s_corner_first+=(document.getElementById('sbl_corner').checked?'bl ':'');
	s_corner_last=(document.getElementById('str_corner').checked?'tr ':'');
...
function do_levelx_corner(){
	
	menustyle=document.getElementById('menustyle').value;
	x_style=document.getElementById('x_corner_style').value;
	x_size=document.getElementById('x_corner_size').value;
        if(menustyle=='columnmenu'){
       x_corner_first=(document.getElementById('xtl_corner').checked?'tl ':'');
	x_corner_first+=(document.getElementById('xbl_corner').checked?'bl ':'');
	x_corner_last=(document.getElementById('xtr_corner').checked?'tr ':'');
	x_corner_last+=(document.getElementById('xbr_corner').checked?'br ':'');
      //  jQuery('.sub_preview.levelx').uncorner();
jQuery('.levelx_outer').uncorner();
//jQuery('.levelx_outer').css('background-color','transparent');
jQuery('.levelx_outer').css('padding','0px');
       if(x_corner_first&&(x_style!='none')){jQuery('.levelx_outer.first').corner('keep '+x_style+' '+x_corner_first+' '+x_size+'px');}
if(x_corner_last&&(x_style!='none')){jQuery('.levelx_outer.last').corner('keep '+x_style+' '+x_corner_last+' '+x_size+'px');}
	
        }else{
	x_corner_first=(document.getElementById('xtl_corner').checked?'tl ':'');
	x_corner_first+=(document.getElementById('xtr_corner').checked?'tr ':'');
	x_corner_last=(document.getElementById('xbl_corner').checked?'bl ':'');
	x_corner_last+=(document.getElementById('xbr_corner').checked?'br ':'');
	
	
jQuery('.sub_preview.levelx').uncorner();
jQuery('#levelx_preview_outer').uncorner();
jQuery('#levelx_preview_outer').css('background-color','transparent');
jQuery('#levelx_preview_outer').css('padding','0px');
//jQuery('.sub_preview.level1').parent().css('background-color','transparent');
//	jQuery('.sub_preview.level1').parent().css('padding','0px');

if((document.getElementById('levelx_outside_border_width').value>0)&&(document.getElementById('levelx_outside_border_style').value!='none')&&x_style!='none'){
	col=document.getElementById('levelx_outside_border_color').value;
	b_width=document.getElementById('levelx_outside_border_width').value;
	bw=parseInt(x_size)+parseInt(b_width);
	jQuery('#levelx_preview_outer').css('border','0');
	jQuery('.sub_preview.levelx').css('border','0');
	jQuery('#levelx_preview_outer').css('background-color',col);
	jQuery('#levelx_preview_outer').css('padding',(parseInt(b_width))+'px');
	jQuery('#levelx_preview_outer').corner('keep '+x_style+' '+x_corner_first+' '+x_corner_last+' '+bw+'px');
	
	//jQuery('#sub_preview_outer').corner(s_style+' '+s_corner_first+' '+s_corner_last+' '+s_size+'px');	
if(x_corner_first&&(x_style!='none')){jQuery('.sub_preview.levelx.first').corner('keep '+x_style+' '+x_corner_first+' '+x_size+'px');}
if(x_corner_last&&(x_style!='none')){jQuery('.sub_preview.levelx.last').corner('keep '+x_style+' '+x_corner_last+' '+x_size+'px');}
//if(si_corner&&(si_style!='none')){jQuery('.sub_preview.level1').corner('keep '+si_style+' '+si_corner+' '+si_size+'px');}
	
	
}else if(x_style=='none'){
doLevelxBorder();
}else{
//if(si_corner&&(si_style!='none')){jQuery('.sub_preview.level1').corner('keep '+si_style+' '+si_corner+' '+si_size+'px');}
...
function do_levelx_inside_corner(){
	
	xi_style=document.getElementById('xi_corner_style').value;
	xi_size=document.getElementById('xi_corner_size').value;
	xi_corner=(document.getElementById('xitl_corner').checked?'tl ':'');
	xi_corner+=(document.getElementById('xitr_corner').checked?'tr ':'');
	xi_corner+=(document.getElementById('xibl_corner').checked?'bl ':'');
	xi_corner+=(document.getElementById('xibr_corner').checked?'br ':'');
	
	jQuery('.sub_preview.levelx').uncorner();
//jQuery('.sub_preview.levelx').parent().uncorner();
//jQuery('.sub_preview.level1').parent().css('background-color','transparent');
//jQuery('#sub_preview_parent').css('padding','0px');
//jQuery('.sub_preview.levelx').parent().css('background-color','transparent');
	jQuery('.sub_preview.levelx').parent().css('padding','0px');

if((document.getElementById('levelx_inside_border_width').value>0)&&(document.getElementById('levelx_inside_border_style').value!='none')&&xi_style!='none'){
	col=document.getElementById('levelx_inside_border_color').value;
	b_width=document.getElementById('levelx_inside_border_width').value;
	bw=parseInt(xi_size)+parseInt(b_width);
	//jQuery('#levelx_preview_outer').css('border','0');
	jQuery('.sub_preview.levelx').css('border','0');
	jQuery('.sub_preview.levelx').parent().css('border','0');
	jQuery('.sub_preview.levelx').parent().css('background-color',col);
	jQuery('.sub_preview.levelx').parent().css('padding',(parseInt(b_width))+'px');
	jQuery('.sub_preview.levelx').parent().corner('keep '+xi_style+' '+xi_corner+' '+bw+'px');
	
	//jQuery('#sub_preview_outer').corner(s_style+' '+s_corner_first+' '+s_corner_last+' '+s_size+'px');	
if(xi_corner&&(xi_style!='none')){jQuery('.sub_preview.levelx').corner('keep '+xi_style+' '+xi_corner+' '+xi_size+'px');}	
	
}else if(xi_style=='none'){
doLevelxBorder();
}else{
if(xi_corner&&(xi_style!='none')){jQuery('.sub_preview.levelx').corner('keep '+xi_style+' '+xi_corner+' '+xi_size+'px');}
}
...
el= document.getElementById("sub_active_background");
if(el.value!=''){jQuery('.sub_preview.level1.active').css('background-color',el.value);}else{jQuery('.sub_preview.level1.active').css('background-color','transparent');}
...
el= document.getElementById("sub_active_background_image");
jQuery('.sub_preview.level1.active').css('background-image','url(../'+el.value+')');
...
jQuery('.sub_preview.level1').css('font-family',el.value);	

el=document.getElementById('sub_font_size');	
		
jQuery('.sub_preview.level1').css('font-size',el.value+'px');	


var el=document.getElementById('levelx_sub_font_family');	
		
jQuery('.sub_preview.levelx').css('font-family',el.value);	

el=document.getElementById('levelx_sub_font_size');	
		
jQuery('.sub_preview.levelx').css('font-size',el.value+'px');	
...
jQuery('.sub_preview.level1').css('font-weight',el.value);	

el=document.getElementById('levelx_sub_font_weight');	
		
jQuery('.sub_preview.levelx').css('font-weight',el.value);	

el=document.getElementById('sub_align');	
		
jQuery('.sub_preview.level1').css('text-align',el.value);

el=document.getElementById('levelx_sub_font_align');	
		
jQuery('.sub_preview.levelx').css('text-align',el.value);

el=document.getElementById('sub_wrap');	
		
jQuery('.sub_preview.level1').css('white-space',el.value);	

el=document.getElementById('levelx_sub_font_wrap');	
		
jQuery('.sub_preview.levelx').css('white-space',el.value);	
...
jQuery('.sub_preview.level1').css('color',el.value);
...
el= document.getElementById("levelx_sub_font_color");
jQuery('.sub_preview.levelx').css('color',el.value);

if(document.getElementById( "levelx_sub_ttf" ).value!=''){
	do_sub_ttf2();
}

el= document.getElementById("levelx_sub_font_color_over");
jQuery('.sub_preview.levelx.hover').css('color',el.value);
...
if(el.value!=''){jQuery('.sub_preview.level1.normal').css('background-color',el.value);}else{jQuery('.sub_preview.level1.normal').css('background-color','transparent');}

el= document.getElementById("sub_over");
if(el.value!=''){jQuery('.sub_preview.level1.hover').css('background-color',el.value);}else{jQuery('.sub_preview.level1.hover').css('background-color','transparent');}

el= document.getElementById("levelx_sub_back");
if(document.getElementById('menustyle').value=="columnmenu"){
 if(el.value!=''){jQuery('.levelx_outer').css('background-color',el.value);}else{jQuery('.levelx_outer').css('background-color','transparent');}   
}else{
if(el.value!=''){jQuery('.sub_preview.levelx.normal').css('background-color',el.value);}else{jQuery('.sub_preview.levelx.normal').css('background-color','transparent');}
}
el= document.getElementById("levelx_sub_over");
if(el.value!=''){jQuery('.sub_preview.levelx.hover').css('background-color',el.value);}else{jQuery('.sub_preview.levelx.hover').css('background-color','transparent');}

el= document.getElementById("sub_back_image");
jQuery('.sub_preview.level1.normal').css('background-image','url(../'+el.value+')');

el= document.getElementById("sub_back_image_over");
jQuery('.sub_preview.level1.hover').css('background-image','url(../'+el.value+')');


el= document.getElementById("levelx_sub_back_image");
jQuery('.sub_preview.levelx.normal').css('background-image','url(../'+el.value+')');

el= document.getElementById("levelx_sub_back_image_over");
jQuery('.sub_preview.levelx.hover').css('background-image','url(../'+el.value+')');
...
jQuery('#levelx_sub_table').css('background-color',document.getElementById('levelx_sub_back').value);
jQuery('#top_sub_table').css('background-image','url(..'+document.getElementById('main_back_image').value+')');
jQuery('#sub_sub_table').css('background-image','url(..'+document.getElementById('sub_back_image').value+')');
jQuery('#levelx_sub_table').css('background-image','url(..'+document.getElementById('levelx_sub_back_image').value+')');
...
function doColorChange(el){
	...
	if(el.value!=""){
		if(el.id=='complete_background'){
			...
			jQuery('.sub_preview.level1.normal').css('background-color',el.value);
		}else if(el.id=='sub_over'){
			jQuery('.sub_preview.level1.hover').css('background-color',el.value);
		}else if((el.id=='levelx_sub_back')&&(document.getElementById('menustyle').value=='columnmenu')){
                   // alert(jQuery('.levelx_outer').css('background-color'));
                   // jQuery('.levelx_outer').css({'background-color':''});
			jQuery('.levelx_outer').css('background-color',el.value);
		}else if((el.id=='levelx_sub_back')&&(document.getElementById('menustyle').value!='columnmenu')){
			jQuery('.sub_preview.levelx.normal').css('background-color',el.value);
		}else if(el.id=='levelx_sub_over'){
			jQuery('.sub_preview.levelx.hover').css('background-color',el.value);
		}else if(el.id=='active_background'){
			jQuery('#top_preview_active').css('background-color',el.value);
		}else if(el.id=='sub_active_background'){
			jQuery('.sub_preview.level1.active').css('background-color',el.value);
		}
	}else{
		if(el.id=='complete_background'){
			...
			jQuery('.sub_preview.level1.normal').css('background-color','transparent');
		
		}else if(el.id=='sub_over'){
			jQuery('.sub_preview.level1.hover').css('background-color','transparent');
		}else if(el.id=='levelx_sub_back'){
			jQuery('.sub_preview.levelx.normal').css('background-color','transparent');
		
		}else if(el.id=='levelx_sub_over'){
			jQuery('#sub_preview.levelx.hover').css('background-color','transparent');
		}else if(el.id=='active_background'){
			jQuery('#top_preview_active').css('background-color','transparent');
		}else if(el.id=='sub_active_background'){
			jQuery('.sub_preview.level1.active').css('background-color','transparent');
		}
	}
	jQuery('#top_sub_table').css('background-color',document.getElementById('main_back').value);
jQuery('#sub_sub_table').css('background-color',document.getElementById('sub_back').value);
...
function do_sub_ttf(){
	...
	if(document.getElementById('sub_ttf').value==""){
		// Cufon.replace('.top_preview');
		remove_cufon('#sub_preview1');
		remove_cufon('#sub_preview2');
		remove_cufon('#sub_preview3');
		remove_cufon('#sub_preview4');
 ...
 jQuery.getScript(s2, function() {
            ...
            Cufon.replace('#sub_preview1',{fontFamily:str});
            Cufon.replace('#sub_preview2',{fontFamily:str});
            Cufon.replace('#sub_preview3',{fontFamily:str});
            Cufon.replace('#sub_preview4',{fontFamily:str});
...
function do_sub_ttf2(){
	
		var str=jQuery('#levelx_sub_ttf option:selected').text();
	
	if(document.getElementById('levelx_sub_ttf').value==""){
		remove_cufon('#sub_preview5');
		remove_cufon('#sub_preview6');
		remove_cufon('#sub_preview7');
		remove_cufon('#sub_preview8');
	
	}else{
	
	s2="../modules/mod_swmenupro/fonts/"+document.getElementById('levelx_sub_ttf').value;


 jQuery.getScript(s2, function() {
 
	 Cufon.replace('#sub_preview5',{fontFamily:str});
			Cufon.replace('#sub_preview6',{fontFamily:str});
            Cufon.replace('#sub_preview7',{fontFamily:str});
			Cufon.replace('#sub_preview8',{fontFamily:str});
        });
...
if(str=="None"){
	document.getElementById('levelx_sub_font_face').value="";
	}else{
document.getElementById('levelx_sub_font_face').value=str;
}
//Cufon.replace('.top_preview',{hover: true});
}
...
function doLevel1Width(cw){

jQuery('#top_preview_parent').css('width',cw+'%');
...
function doSliders(){
		...
		var slider1 = jQuery( "<div align='left' style='width:150px;float:left;margin-left:10px;' id='slider1'></div>" ).insertBefore( select1 ).slider({
			min: 1,
			max: 80,
			range: "min",
			value: select1.value,
		...
		var slider2 = jQuery( "<div align='left' style='width:150px;float:left;margin-left:10px;' id='slider2'></div>" ).insertBefore( select2 ).slider({
			min: 1,
			max: 40,
			range: "min",
			value: select2.value,
		...
		var slider3 = jQuery( "<div align='left' style='width:150px;float:left;margin-left:10px;' id='slider3'></div>" ).insertBefore( select3 ).slider({
			min: 1,
			max: 40,
			range: "min",
			value: select3.value,
		...
		var slider4 = jQuery( "<div align='left' style='width:160px;float:left;margin-left:10px;' id='slider4'></div>" ).insertBefore( select4 ).slider({
			min: 0,
			max: 10,
			range: "min",
			value: select4.value,
		...
		var slider5 = jQuery( "<div align='left' style='width:160px;float:left;margin-left:10px;' id='slider5'></div>" ).insertBefore( select5 ).slider({
			min: 0,
			max: 10,
			range: "min",
			value: select5.value,
		...
		//4alert(select.value);
		var slider6 = jQuery( "<div align='left' style='width:160px;float:left;margin-left:10px;' id='slider6'></div>" ).insertBefore( select6 ).slider({
			min: 0,
			max: 10,
			range: "min",
			value: select6.value,
		...
		//4alert(select.value);
		var slider7 = jQuery( "<div align='left' style='width:160px;float:left;margin-left:10px;' id='slider7'></div>" ).insertBefore( select7 ).slider({
			min: 0,
			max: 10,
			range: "min",
			value: select7.value,
		...
		var slider9 = jQuery( "<div align='left' style='width:170px;float:left;margin-left:10px;' id='slider9'></div>" ).insertBefore( select9 ).slider({
			...
			slide: function( event, ui ) {
				...
				jQuery('.sub_preview.level1').css('font-size',select9.value+'px');
				if(document.getElementById( "sub_ttf" ).value!=''){
					var str=jQuery('#sub_ttf option:selected').text();
				    Cufon.replace('.sub_preview.level1',{fontSize:select9.value+'px',fontFamily:str});
				}
			}
		});
		...
		var slider10 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider10'></div>" ).insertBefore( select10 ).slider({
			min: 0,
			max: 300,
			range: "min",
		...
		var slider11 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider11'></div>" ).insertBefore( select11 ).slider({
			min: 0,
			max: 200,
			range: "min",
		...
		var slider12 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider12'></div>" ).insertBefore( select12 ).slider({
			min: 0,
			max: 300,
			range: "min",
			...
			slide: function( event, ui ) {
				...
				if(select12.value!=0){
					jQuery('.sub_preview.level1').css('width',select12.value+'px');
				}else{
					jQuery('.sub_preview.level1').css({'width':''});
				}
			}
		});
		...
		var slider13 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider13'></div>" ).insertBefore( select13 ).slider({
			min: 0,
			max: 200,
			range: "min",
			...
			slide: function( event, ui ) {
				...
				if(select13.value!=0){
					jQuery('.sub_preview.level1').css('height',select13.value+'px');
				}else{
					jQuery('.sub_preview.level1').css({'height':''});
				}
			}
		});
		...
		var slider30 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider30'></div>" ).insertBefore( select30 ).slider({
			min: -100,
			max: 100,
			range: "min",
		...
		var slider31 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider31'></div>" ).insertBefore( select31 ).slider({
			min: -100,
			max: 100,
			range: "min",
		...
		var slider32 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider32'></div>" ).insertBefore( select32 ).slider({
			min: -100,
			max: 100,
			range: "min",
		...
		var slider33 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider33'></div>" ).insertBefore( select33 ).slider({
			min: -100,
			max: 100,
			range: "min",
		...
		var select34 = document.getElementById( "levelx_sub_top" );
		var slider34 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider34'></div>" ).insertBefore( select34 ).slider({
			min: -100,
			max: 100,
			range: "min",
		...
		var select35 = document.getElementById( "levelx_sub_left" );
		var slider35 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider35'></div>" ).insertBefore( select35 ).slider({
			min: -100,
			max: 100,
			range: "min",
		...
		var slider36 = jQuery( "<div align='left' style='width:100px;float:left;margin-left:10px;' id='slider36'></div>" ).insertBefore( select36 ).slider({
			min: 0,
			max: 1000,
			range: "min",
		...
		var slider37 = jQuery( "<div align='left' style='width:100px;float:left;margin-left:10px;' id='slider37'></div>" ).insertBefore( select37 ).slider({
			min: 0,
			max: 100,
			range: "min",
		...
		var select42 = document.getElementById( "levelx_sub_font_size" );
		var slider42 = jQuery( "<div align='left' style='width:170px;float:left;margin-left:10px;' id='slider42'></div>" ).insertBefore( select42 ).slider({
			min: 0,
			max: 50,
			range: "min",
			value: select42.value,
			slide: function( event, ui ) {
				select42.value = ui.value ;
				jQuery('.sub_preview.levelx').css('font-size',select42.value+'px');
				//jQuery('.sub_preview.level1').css('font-size',select40.value+'px');
				if(document.getElementById( "levelx_sub_ttf" ).value!=''){
					var str=jQuery('#levelx_sub_ttf option:selected').text();
				    Cufon.replace('.sub_preview.levelx',{fontSize:select42.value+'px',fontFamily:str});
				}
			}
		});
		jQuery( "#levelx_sub_font_size" ).change(function() {
			slider42.slider( "value", select42.value );
			if(document.getElementById( "levelx_sub_ttf" ).value!=''){
					var str=jQuery('#levelx_sub_ttf option:selected').text();
				    Cufon.replace('.sub_preview.levelx',{fontSize:select42.value+'px',fontFamily:str});
				}
		...
		var select43 = document.getElementById( "levelx_sub_pad_top" );
		var slider43 = jQuery( '#slider43' ).slider({
			min: 0,
			max: 50,
			range: "min",
		...
		jQuery( "#levelx_sub_pad_top" ).change(function() {
			slider43.slider( "value", select43.value );
			doSubPadding();
		});
		var select44 = document.getElementById( "levelx_sub_pad_right" );
		var slider44 = jQuery( '#slider44' ).slider({
			min: 0,
			max: 50,
			range: "min",
			value: select44.value,
			slide: function( event, ui ) {
				select44.value = ui.value ;
				doSubPadding();
			}
		});
		jQuery( "#levelx_sub_pad_right" ).change(function() {
			slider44.slider( "value", select44.value );
			doSubPadding();
		});
		var select45 = document.getElementById( "levelx_sub_pad_bottom" );
		var slider45 = jQuery( '#slider45' ).slider({
			min: 0,
			max: 50,
			range: "min",
			value: select45.value,
			slide: function( event, ui ) {
				select45.value = ui.value ;
				doSubPadding();
			}
		});
		jQuery( "#levelx_sub_pad_bottom" ).change(function() {
			slider45.slider( "value", select45.value );
			doSubPadding();
		});
		var select46 = document.getElementById( "levelx_sub_pad_left" );
		var slider46 = jQuery( '#slider46' ).slider({
			min: 0,
			max: 50,
			range: "min",
			value: select46.value,
			slide: function( event, ui ) {
				select46.value = ui.value ;
				doSubPadding();
			}
		});
		jQuery( "#levelx_sub_pad_left" ).change(function() {
			slider46.slider( "value", select46.value );
			doSubPadding();
		});

	
	var select47 = document.getElementById( "levelx_sub_width" );
		var slider47 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider47'></div>" ).insertBefore( select47 ).slider({
			min: 0,
			max: 300,
			range: "min",
			value: select47.value,
			slide: function( event, ui ) {
				select47.value = ui.value ;
				if(select47.value!=0){
					jQuery('.sub_preview.levelx').css('width',select47.value+'px');
				}else{
					jQuery('.sub_preview.levelx').css({'width':''});
				}
			}
		});
		jQuery( "#levelx_sub_width" ).change(function() {
			slider47.slider( "value", select47.value );
			select47.value = ui.value ;
				if(select47.value!=0){
					jQuery('.sub_preview.levelx').css('width',select47.value+'px');
				}else{
		...
		var select48 = document.getElementById( "levelx_sub_height" );
		var slider48 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider48'></div>" ).insertBefore( select48 ).slider({
			min: 0,
			max: 200,
			range: "min",
			value: select48.value,
			slide: function( event, ui ) {
				select48.value = ui.value ;
				if(select48.value!=0){
					jQuery('.sub_preview.levelx').css('height',select48.value+'px');
				}else{
					jQuery('.sub_preview.levelx').css({'height':''});
				}
			}
		});
		jQuery( "#levelx_sub_height" ).change(function() {
			slider48.slider( "value", select48.value );
			if(select48.value!=0){
					jQuery('.sub_preview.levelx').css('height',select48.value+'px');
				}else{
					jQuery('.sub_preview.levelx').css({'height':''});
	...
	var select49 = document.getElementById( "levelx_sub_indicator_top" );
		var slider49 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider49'></div>" ).insertBefore( select49 ).slider({
			min: -100,
			max: 100,
			range: "min",
			value: select49.value,
			slide: function( event, ui ) {
				select49.value = ui.value ;
				//do_complete_corner();
			}
		});
		jQuery( "#levelx_sub_indicator_top" ).change(function() {
			slider49.slider( "value", select49.value );
			
		});
		
		
		var select50 = document.getElementById( "levelx_sub_indicator_left" );
		var slider50 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider50'></div>" ).insertBefore( select50 ).slider({
			min: -100,
			max: 100,
			range: "min",
			value: select50.value,
			slide: function( event, ui ) {
				select50.value = ui.value ;
				//do_top_corner();
			}
		});
		jQuery( "#levelx_sub_indicator_left" ).change(function() {
			slider50.slider( "value", select50.value );
			
		});
	
	
	var select51 = document.getElementById( "si_corner_size" );
		var slider51 = jQuery( "<div align='left' style='width:150px;float:left;margin-left:10px;' id='slider51'></div>" ).insertBefore( select51 ).slider({
			min: 1,
			max: 40,
			range: "min",
			value: select51.value,
			slide: function( event, ui ) {
				select51.value = ui.value ;
				do_sub_inside_corner();
			}
		});
		jQuery( "#si_corner_size" ).change(function() {
			slider51.slider( "value", select51.value );
			do_sub_inside_corner();
			
		});
		
		var select52 = document.getElementById( "xi_corner_size" );
		var slider52 = jQuery( "<div align='left' style='width:150px;float:left;margin-left:10px;' id='slider52'></div>" ).insertBefore( select52 ).slider({
			min: 1,
			max: 40,
			range: "min",
			value: select52.value,
			slide: function( event, ui ) {
				select52.value = ui.value ;
				do_levelx_inside_corner();
			}
		});
		jQuery( "#xi_corner_size" ).change(function() {
			slider52.slider( "value", select52.value );
			do_levelx_inside_corner();
			
		});
		
		var select53 = document.getElementById( "x_corner_size" );
		var slider53 = jQuery( "<div align='left' style='width:150px;float:left;margin-left:10px;' id='slider53'></div>" ).insertBefore( select53 ).slider({
			min: 1,
			max: 40,
			range: "min",
			value: select53.value,
			slide: function( event, ui ) {
				select53.value = ui.value ;
				do_levelx_corner();
			}
		});
		jQuery( "#x_corner_size" ).change(function() {
			slider53.slider( "value", select53.value );
			do_levelx_corner();
			
		});
		
		var select54 = document.getElementById( "levelx_outside_border_width" );
		//4alert(select.value);
		var slider54 = jQuery( "<div align='left' style='width:160px;float:left;margin-left:10px;' id='slider54'></div>" ).insertBefore( select54 ).slider({
			min: 0,
			max: 10,
			range: "min",
			value: select54.value,
			slide: function( event, ui ) {
				select54.value = ui.value ;
				doLevelxBorder();
			}
		});
		jQuery( "#levelx_outside_border_width" ).change(function() {
			slider54.slider( "value", select54.value );
			doLevelxBorder();
			
		});
		
		var select55 = document.getElementById( "levelx_inside_border_width" );
		//4alert(select.value);
		var slider55 = jQuery( "<div align='left' style='width:160px;float:left;margin-left:10px;' id='slider55'></div>" ).insertBefore( select55 ).slider({
			min: 0,
			max: 10,
			range: "min",
			value: select55.value,
			slide: function( event, ui ) {
				select55.value = ui.value ;
				doLevelxBorder();
			}
		});
		jQuery( "#levelx_inside_border_width" ).change(function() {
			slider55.slider( "value", select55.value );
			doLevelxBorder();
			
		});
		
		if(document.getElementById('menustyle').value=='multitabmenu'){
		var select56 = document.getElementById( "complete_width" );
		//4alert(select.value);
		var slider56 = jQuery( "<div align='left' style='width:120px;float:left;margin-left:10px;' id='slider56'></div>" ).insertBefore( select56 ).slider({
			min: 0,
			max: 100,
			range: "min",
			value: select56.value,
			slide: function( event, ui ) {
				select56.value = ui.value ;
				doLevel1Width(ui.value);
			}
		});
		jQuery( "#complete_width" ).change(function() {
			slider56.slider( "value", select56.value );
			doLevel1Width(select56.value);
