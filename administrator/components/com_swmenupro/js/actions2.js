...
function treeInfo() {
 ...
 var ncss = document.getElementById("tree-normal_css");
  var ocss = document.getElementById("tree-over_css");
   var custom_html = document.getElementById("tree-custom_html");
    var html_position = document.getElementById("tree-html_position");
...
//alert(node.image);
        ...
        ncss.value = node.ncss;
		  custom_html.value = node.custom_html;
		   html_position.value = node.html_position;
...
//	name.value = name.value.trim();
 //   href.value = href.value.trim();
  ...
  //  }
    ...
    node.custom_html = custom_html.value;
	 node.html_position = html_position.value;
	// alert(node.html_position);
...
function treePluginExportPhp() {
	...
	// document.getElementById("php_out").value = tree.exportToSql();
