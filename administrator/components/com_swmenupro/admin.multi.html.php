...
function multiMenuConfig( $rows,$row2, $ordered, $lists,$orders3)
{
  ...
  $absolute_path=JPATH_ROOT;
   ...
   switch ($rows->menustyle){
		case "multitabmenu":
			$menutype2="Mega Tab Menu";
			break;
		case "clicktransmenu":
			$menutype2="Click - Trans Menu";
			break;
		case "accordtransmenu":
			$menutype2="Accordion - Trans Menu";
			break;
		case "columnmenu":
			$menutype2="Multi Column Menu";
			break;
		default:
...
<script type="text/javascript" src="components/com_swmenupro/js/swmenupro_multi.js"></script>
...
//-->
 ...
 <style type='text/css'>
            ...
            .sub_preview.levelx{
                display:block;
                 padding:<?php echo $rows->levelx_sub_pad_top."px ".$rows->levelx_sub_pad_right."px ".$rows->levelx_sub_pad_bottom."px ".$rows->levelx_sub_pad_left."px"; ?>;
               

                color:<?php echo $rows->levelx_sub_font_color; ?>;
                font-size:<?php echo $rows->levelx_sub_font_size; ?>px;
                font-family:<?php echo $rows->levelx_sub_font_family; ?>;
                font-weight:<?php echo $rows->levelx_sub_font_weight; ?>;
                <?php
                if ($rows->sub_width != 0) {
                  //  echo " width:" . $rows->sub_width . "px; \n";
                }
                ...
                ?>
                text-align:<?php echo $rows->levelx_sub_font_align; ?>;
                white-space:<?php echo $rows->levelx_sub_font_wrap; ?>;
             
                <?php
                switch ($rows->levelx_sub_font_extra) {
                    case "italic":
                    case "oblique":
                        echo " font-style:" . $rows->levelx_sub_font_extra . ";\n";
                        echo " text-decoration: none ;\n";
                        echo " text-transform: none ;\n";
                        break;
                    case "underline":
                    case "overline":
                    case "line-through":
                        echo " text-decoration:" . $rows->levelx_sub_font_extra . " ;\n";
                        echo " font-style: none ;\n";
                        echo " text-transform: none ;\n";
                        break;
                    case "uppercase":
                    case "lowercase":
                    case "capitalize":
                        echo " text-transform:" . $rows->levelx_sub_font_extra . " ;\n";
                        echo " text-decoration: none ;\n";
                        echo " font-style: none ;\n";
                        break;
                    default:
            ...
            .sub_preview.levelx.hover{
                background-image:<?php echo "url('../" . $rows->levelx_sub_back_image_over . "')"; ?>;
                background-repeat:<?php echo $rows->levelx_sub_hover_background_repeat; ?>;
                background-position:<?php echo $rows->levelx_sub_hover_background_position; ?>;
                background-color:<?php echo $rows->levelx_sub_over; ?>;
                color:<?php echo $rows->levelx_sub_font_color_over; ?>;
            ...
            <?php
            if ($rows->menustyle=='columnmenu'){
                ?>
            
            .levelx_outer  {
               background-color:<?php echo $rows->levelx_sub_back; ?>;
            position:relative;
               
                background-image:<?php echo "url('../" . $rows->levelx_sub_back_image . "')"; ?>;
                background-repeat:<?php echo $rows->levelx_sub_background_repeat; ?>;
                background-position:<?php echo $rows->levelx_sub_background_position; ?>;
            }
<?php }else{ ?>
              #sub_preview_outer{
                position:relative;
...
<table class="swmenu_tabheading" style="margin:auto;" >
  <tr>
   <td width="80%"> <?php echo _SW_MODULE_NAME.": ". $row2->title; ?>
                        ...
                        <tr>
                            <td width="50%" valign="top" align="center">
                                <table class="sw_table_left"  >
                                  ...
                                  <?php if($rows->menustyle=="accordtransmenu"){
                                      ?>
                                     ...
                                     <tr>
          <td><?php echo _SW_LEVEL." X - "._SW_ALIGNMENT; ?>:</td>
          <td> <div align="right"><?php echo ($rows->menustyle=="accordtransmenu"?$lists['levelx_align']:$lists['level1_align']); ?></div>
           <input type="hidden" name="orientation" id="orientation" value="vertical" /></td>
        </tr>
                                    
                                    <?php
                                  }else if($rows->menustyle=="columnmenu"){
                                      ?>
                                      <tr class="swmenu_menubackgr">
                                        <td><?php echo _SW_TOP_MENU . " - " . _SW_ALIGNMENT; ?>:</td>
                                        <td> <div align="right"><?php echo $lists['position']; ?></div></td>
                                    ...
                                    <tr class="swmenu_menubackgr">
                                        ...
                                        <td><?php echo _SW_LEVELX . " - " . _SW_ORIENTATION; ?>:</td>
                                        <td> <div align="right"><?php echo $lists['orientation']; ?></div></td>
                                    </tr>
                                    <tr class="swmenu_menubackgr">
          <td><?php echo _SW_LEVEL." 1 - "._SW_ALIGNMENT; ?>:</td>
          <td> <div align="right"><?php echo $lists['level1_align']; ?></div></td>
        </tr><tr>
          <td><?php echo _SW_LEVEL." 1 - "._SW_WIDTH; ?>:</td>
          <td> <div align="right"><?php echo $lists['level1_width']; ?></div></td>
        </tr><tr class="swmenu_menubackgr">
          <td><?php echo _SW_COMPLETE_MENU." "._SW_WIDTH; ?></td>
          <td> <div align="right">
          <input type="text" size="4" id="complete_width" name="complete_width" value="<?php echo $rows->complete_width;?>" />%</div></td>
        </tr>
        <?php } ?>
        ...
        <tr>
                                        ...
                                        <td><?php echo _SW_LEVEL . " 1 - " . _SW_ITEM_WIDTH; ?></td>
                                        <td> <div align="right">
                                                <input type="text" size="4" id="sub_width" name="sub_width" value="<?php echo $rows->sub_width; ?>"/>px</div></td>
                                    </tr><tr>
                                        <td><?php echo _SW_LEVEL . " 1 - ". _SW_ITEM_HEIGHT; ?></td>
                                        <td> <div align="right">
                                                <input id="sub_height" name="sub_height" type="text" value="<?php echo $rows->sub_height; ?>" size="4"/>px</div></td>
                                    </tr><tr class="swmenu_menubackgr">
                                        <td><?php echo _SW_LEVEL . " X - " . _SW_ITEM_WIDTH; ?></td>
                                        <td> <div align="right">
                                                <input type="text" size="4" id="levelx_sub_width" name="levelx_sub_width" value="<?php echo $rows->levelx_sub_width; ?>"/>px</div></td>
                                    </tr><tr>
                                        <td><?php echo _SW_LEVEL . " X - " . _SW_ITEM_HEIGHT; ?></td>
                                        <td> <div align="right">
                                                <input id="levelx_sub_height" name="levelx_sub_height" type="text" value="<?php echo $rows->levelx_sub_height; ?>" size="4"/>px</div></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo _SW_LEVEL . " X - " . _SW_TOP_OFFSET; ?>:</td>
                                        <td> <div align="right">
                                                <input type="text" size="4" id="levelx_sub_top" name="levelx_sub_top" value="<?php echo $rows->levelx_sub_top; ?>"/>px</div></td>
                                    </tr><tr>
                                        <td><?php echo _SW_LEVEL . " X - " . _SW_LEFT_OFFSET; ?>:</td>
                                        <td> <div align="right">
                                                <input type="text" size="4" id="levelx_sub_left" name="levelx_sub_left" value="<?php echo $rows->levelx_sub_left; ?>"/>px</div></td>
                                    </tr>
                            ...
                            <td width="50%" valign="top" align="center">
                                <table class="sw_table_right"  >
                                    ...
                                    <tr>
                                      ...
                                      <tr>
              <td colspan="2" class="swmenu_tabheading"><div align="center"><?php echo _SW_SUB_MENU." "._SW_LEVEL." X "._SW_PADDING; ?></div></td>
            </tr><tr>
              <td colspan="2" align="center">
                <table>
                  <tr class="swmenu_menubackgr">
                    ...
                    <td width="88" align="center"><?php echo _SW_LEFT; ?></td>
                                                    ...
                                                    <td width="90" align="center"><input type="text" onchange="doSubPadding();" size="3" id="levelx_sub_pad_top" name="levelx_sub_pad_top" value="<?php echo $rows->levelx_sub_pad_top; ?>" maxlength="3" />px</td>
                                                    <td width="90" align="center"><input type="text" onchange="doSubPadding();" size="3" id="levelx_sub_pad_right" name="levelx_sub_pad_right" value="<?php echo $rows->levelx_sub_pad_right; ?>" maxlength="3" />px</td>
                                                    <td width="90" align="center"><input type="text" onchange="doSubPadding();" size="3" id="levelx_sub_pad_bottom" name="levelx_sub_pad_bottom" value="<?php echo $rows->levelx_sub_pad_bottom; ?>" maxlength="3" />px</td>
                                                    <td width="90" align="center"><input type="text" onchange="doSubPadding();" size="3" id="levelx_sub_pad_left" name="levelx_sub_pad_left" value="<?php echo $rows->levelx_sub_pad_left; ?>" maxlength="3" />px</td>
                                                </tr><tr>
                    <td width="88" align="center"><div style='width:70px;' id='slider43'></div></td>
                    <td width="88" align="center"><div style='width:70px;' id='slider44'></div></td>
                    <td width="88" align="center"><div style='width:70px;' id='slider45'></div></td>
                    <td width="88" align="center"><div style='width:70px;' id='slider46'></div></td>
                  </tr>
                </table>
              </td>
            </tr>
  ...
  <tr>
    <td width="50%" valign="top" align="center"> 
      ...
      <tr>
          <td><?php echo _SW_TOP_MENU_ACTIVE; ?>:</td>
          <td align="right"> 
     ...
     <tr>
       ...
       <tr class="swmenu_menubackgr" >
          <td><?php echo _SW_SUB_MENU_ACTIVE; ?>:</td>
          <td align="right"> 
          <table  align="right" id="sub_active_background_image_box" style="border: 1px solid #000000; width:120px;margin-right:10px;" background="../<?php echo $rows->sub_active_background_image;?>" align="left"> 
            <tr><td width="100%" height="30">&nbsp;</td></tr>
          </table>
        </td><td align="right">
           <a onMouseOver="this.style.cursor='pointer'" onclick="get_background_image('sub_active_background_image');"><img src="components/com_swmenupro/images/sel.gif"/><?php echo _SW_GET_IMAGE_BUTTON; ?></a>
            <a onMouseOver="this.style.cursor='pointer'" onclick="document.getElementById('sub_active_background_image_box').style.background='none';document.getElementById('sub_active_background_image').value='';doCompletePreview();">&nbsp;<img src="components/com_swmenupro/images/clear.png" hspace="4" align="top" /><?php echo _SW_CLEAR; ?></a>
       
          <input type="hidden" id="sub_active_background_image" name="sub_active_background_image" value="<?php echo $rows->sub_active_background_image;?>"/>
     ...
     <tr class="swmenu_menubackgr" >
        <td align="right" colspan="3"> <?php echo _SW_BACKGROUND_REPEAT; ?>:
        <?php echo $lists['sub_active_background_repeat']; ?>
            <?php echo _SW_BACKGROUND_POSITION; ?>:
          <?php echo $lists['sub_active_background_position']; ?></td>
      </tr>
   ...
   <tr>
     ...
     <tr class="swmenu_menubackgr" >
       ...
       <tr>
       <td><?php echo _SW_LEVEL." X "; ?>:</td>
      <td align="right"> 
          <table  align="right" id="levelx_sub_back_image_box" style="border: 1px solid #000000; width:120px;margin-right:10px;" background="../<?php echo $rows->levelx_sub_back_image;?>" align="left"> 
            <tr><td width="100%" height="30">&nbsp;</td></tr>
          </table>
        </td><td align="right">
           <a onMouseOver="this.style.cursor='pointer'" onclick="get_background_image('levelx_sub_back_image');"><img src="components/com_swmenupro/images/sel.gif"/><?php echo _SW_GET_IMAGE_BUTTON; ?></a>
            <a onMouseOver="this.style.cursor='pointer'" onclick="document.getElementById('levelx_sub_back_image_box').style.background='none';document.getElementById('levelx_sub_back_image').value='';doCompletePreview();">&nbsp;<img src="components/com_swmenupro/images/clear.png" hspace="4" align="top" /><?php echo _SW_CLEAR; ?></a>
       
          <input type="hidden" id="levelx_sub_back_image" name="levelx_sub_back_image" value="<?php echo $rows->levelx_sub_back_image;?>"/>
       
          </td>
     </tr>
     <tr>
        <td align="right" colspan="3"> <?php echo _SW_BACKGROUND_REPEAT; ?>:
        <?php echo $lists['levelx_sub_background_repeat']; ?>
            <?php echo _SW_BACKGROUND_POSITION; ?>:
          <?php echo $lists['levelx_sub_background_position']; ?></td>
      </tr>
     <tr class="swmenu_menubackgr" >
       <td><?php echo _SW_LEVEL." X "._SW_HOVER; ?>:</td>
         <td align="right"> 
          <table  align="right" id="levelx_sub_back_image_over_box" style="border: 1px solid #000000; width:120px;margin-right:10px;" background="../<?php echo $rows->levelx_sub_back_image_over;?>" align="left"> 
            <tr><td width="100%" height="30">&nbsp;</td></tr>
          </table>
        </td><td align="right">
           <a onMouseOver="this.style.cursor='pointer'" onclick="get_background_image('levelx_sub_back_image_over');"><img src="components/com_swmenupro/images/sel.gif"/><?php echo _SW_GET_IMAGE_BUTTON; ?></a>
            <a onMouseOver="this.style.cursor='pointer'" onclick="document.getElementById('levelx_sub_back_image_over_box').style.background='none';document.getElementById('levelx_sub_back_image_over').value='';doCompletePreview();">&nbsp;<img src="components/com_swmenupro/images/clear.png" hspace="4" align="top" /><?php echo _SW_CLEAR; ?></a>
       
          <input type="hidden" id="levelx_sub_back_image_over" name="levelx_sub_back_image_over" value="<?php echo $rows->levelx_sub_back_image_over;?>"/>
       
          </td>
      </tr>
     <tr class="swmenu_menubackgr" >
        <td align="right" colspan="3"> <?php echo _SW_BACKGROUND_REPEAT; ?>:
        <?php echo $lists['levelx_sub_hover_background_repeat']; ?>
            <?php echo _SW_BACKGROUND_POSITION; ?>:
          <?php echo $lists['levelx_sub_hover_background_position']; ?></td>
      </tr>
                                ...
                                <table class="sw_table_right"  >
                                    ...
                                    <tr class="swmenu_menubackgr">
                                        ...
                                        <td>  <div style="float:right;" >
                                                <div id="complete_background_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:20px" bgColor='<?php echo $rows->complete_background; ?>'>
                                    ...
                                    <tr>
                                        <td><?php echo _SW_TOP_MENU_ACTIVE ?>:</td>
                                        <td>  <div style="float:right;" >
                                                <div id="active_background_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:20px" bgColor='<?php echo $rows->active_background; ?>'>
                                    ...
                                    <tr class="swmenu_menubackgr" >
                                        <td><?php echo _SW_SUB_MENU_ACTIVE ?>:</td>
                                        <td>  <div style="float:right;" >
                                                <div id="sub_active_background_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:20px" bgColor='<?php echo $rows->sub_active_background; ?>'>
                                                </div><input type="text" size="8"  onchange="doColorChange(this);" class="color {styleElement:'sub_active_background_box',hash:true,required:false,pickerOnfocus:false,pickerClosable:true}" id="sub_active_background" name="sub_active_background" value="<?php echo $rows->sub_active_background; ?>"/>
                                                <a onMouseOver="this.style.cursor='pointer'" onClick="document.getElementById('sub_active_background').color.showPicker()"><img src="components/com_swmenupro/images/sel.gif" /><?php echo _SW_GET; ?></a>
                                                <a onMouseOver="this.style.cursor='pointer'" onClick="document.getElementById('sub_active_background_box').style.background='none';document.getElementById('sub_active_background').value='';doCompletePreview();">&nbsp;<img src="components/com_swmenupro/images/clear.png" hspace="4" align="top" /><?php echo _SW_CLEAR; ?></a></div></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo _SW_TOP_MENU; ?>:</td>
                                        <td>  <div style="float:right;" >
                                                <div id="main_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:20px" bgColor='<?php echo $rows->main_back; ?>'>
                                                </div>
                                    ...
                                    <tr class="swmenu_menubackgr" >
                                        <td><?php echo _SW_TOP_MENU . " " . _SW_HOVER; ?>:</td>
                                        <td>  <div style="float:right;" >
                                                <div id="main_over_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:20px" bgColor='<?php echo $rows->main_over; ?>'>
                                                </div>
                                    ...
                                    <tr>
                                        <td><?php echo _SW_SUB_MENU; ?>:</td>
                                        <td> <div style="float:right;" >
                                                <div id="sub_back_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:20px" bgColor='<?php echo $rows->sub_back; ?>'>
                                                </div>
                                    ...
                                    <tr class="swmenu_menubackgr" >
                                        <td><?php echo _SW_SUB_MENU . " " . _SW_HOVER; ?>:</td>
                                        <td>  <div style="float:right;" >
                                                <div id="sub_over_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:20px" bgColor='<?php echo $rows->sub_over; ?>'>
                                     ...
                                     <tr>
                                        <td><?php echo _SW_LEVELX; ?>:</td>
                                        <td> <div style="float:right;" >
                                                <div id="levelx_sub_back_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:20px" bgColor='<?php echo $rows->levelx_sub_back; ?>'>
                                                </div>
                                                <input type="text" size="8" onchange="doColorChange(this);" class="color {styleElement:'levelx_sub_back_box',hash:true,required:false,pickerOnfocus:false,pickerClosable:true}"  id="levelx_sub_back" name="levelx_sub_back" value="<?php echo $rows->levelx_sub_back; ?>"/>
                                                <a onMouseOver="this.style.cursor='pointer'" onClick="document.getElementById('levelx_sub_back').color.showPicker()"><img src="components/com_swmenupro/images/sel.gif"/><?php echo _SW_GET; ?></a>
                                                <a onMouseOver="this.style.cursor='pointer'" onClick="document.getElementById('levelx_sub_back_box').style.background='none';document.getElementById('levelx_sub_back').value='';doCompletePreview();">&nbsp;<img src="components/com_swmenupro/images/clear.png" hspace="4" align="top" /><?php echo _SW_CLEAR; ?></a></div></td>
                                    </tr>
                                    <tr class="swmenu_menubackgr" >
                                        <td><?php echo _SW_LEVELX." " . _SW_HOVER; ?>:</td>
                                        <td>  <div style="float:right;" >
                                                <div id="levelx_sub_over_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:20px" bgColor='<?php echo $rows->levelx_sub_over; ?>'>
                                                </div><input type="text" size="8" onchange="doColorChange(this);" class="color {styleElement:'levelx_sub_over_box',hash:true,required:false,pickerOnfocus:false,pickerClosable:true}" id="levelx_sub_over" name="levelx_sub_over" value="<?php echo $rows->levelx_sub_over; ?>"/>
                                                <a onMouseOver="this.style.cursor='pointer'" onClick="document.getElementById('levelx_sub_over').color.showPicker()"><img src="components/com_swmenupro/images/sel.gif"/><?php echo _SW_GET; ?></a>
                                                <a onMouseOver="this.style.cursor='pointer'" onClick="document.getElementById('levelx_sub_over_box').style.background='none';document.getElementById('levelx_sub_over').value='';doCompletePreview();">&nbsp;<img src="components/com_swmenupro/images/clear.png" hspace="4" align="top" /><?php echo _SW_CLEAR; ?></a></div></td>
                                    </tr>
...
<tr>
 ...
 <td align="right"><table style="border: 1px solid #000000; width:100px;margin-right:10px;" align="left"> 
        ...
        <?php echo $lists['sub_sub_indicator_left']; ?>px</div></td>
                                    ...
                                    <tr>
  <td width="33%"><b><?php echo _SW_LEVEL." X "; ?>:</b>
   </td>
 <td align="right"><table style="border: 1px solid #000000; width:100px;margin-right:10px;" align="left"> 
            <tr><td id="levelx_sub_table" align="center" valign="center" width="100%" height="20"><?php echo $lists['levelx_sub_indicator']; ?></td></tr>
          </table>  <a onMouseOver="this.style.cursor='pointer'" onclick="get_background_image('levelx_sub');"><img src="components/com_swmenupro/images/sel.gif"/><?php echo _SW_GET_IMAGE_BUTTON; ?></a>
            <a onMouseOver="this.style.cursor='pointer'" onclick="document.getElementById('levelx_sub').src='../modules/mod_swmenupro/images/empty.gif';document.getElementById('levelx_sub_indicator').value='';">&nbsp;<img src="components/com_swmenupro/images/clear.png" hspace="4" align="top" /><?php echo _SW_CLEAR; ?></a>
             
                                        </td>
                                    <tr class="swmenu_menubackgr">
                                        <td height="20" ><?php echo _SW_ALIGNMENT; ?>:</td>
                                        <td> <div align="right"><?php echo $lists['levelx_sub_indicator_align']; ?></div></td>
                                    </tr>

                                    <tr>
                                        <td height="20"><?php echo _SW_TOP_OFFSET; ?>:</td>
                                        <td> <div align="right">
        <?php echo $lists['levelx_sub_indicator_top']; ?>px</div></td>
                                    </tr><tr class="swmenu_menubackgr">
                                        <td height="20"><?php echo _SW_LEFT_OFFSET; ?>:</td>
                                        <td> <div align="right">
        <?php echo $lists['levelx_sub_indicator_left']; ?>px</div></td>
                                    </tr>
                           ...
                           <td width="50%" valign="top" align="center">
                                <table class="sw_table_left" >
                                    <tr>
                                        ...
                                        <td colspan="2" ><?php echo _SW_LEVEL." X "; ?>:</td>
                                        <td  width="250"><div align="right"><?php echo $lists['levelx_sub_font_family']; ?></div></td>
                                    </tr>
                                    <tr>
                                       <td colspan="3" class="swmenu_tabheading"><div align="center"><?php echo _SW_TRUE_TYPE_FONTS_LABEL; ?> &nbsp;<a class="sw_cufon_button"  href="javascript:void(0);" onclick='get_cufon();'/><?php echo _SW_UPLOAD_TTF; ?></a></div></td>
                                        ...
                                        <td colspan="2" ><?php echo _SW_LEVEL." X "; ?>:</td>
                                        <td width="250"><div align="right"><?php echo $lists['levelx_subTTF']; ?></div></td>
                                    </tr>
                                    ...
                                    <tr  class="swmenu_menubackgr">
                                        <td  colspan="2"><?php echo _SW_TOP_MENU_ACTIVE ?>:</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td  colspan="2"><?php echo _SW_SUB_MENU_ACTIVE ?>:</td>
                                        <td>
                                            <div style="float:right;" >
                                                <div id="sub_active_font_box" style="border: 1px solid #000000; width:20px; height:28px;float:left;margin-right:10px;" bgColor='<?php echo $rows->sub_active_font; ?>'>
                                                </div><input type="text" size="8" onchange="doFontColor(this);" class="color {styleElement:'sub_active_font_box',hash:true,required:false,pickerOnfocus:false,pickerClosable:true}" id="sub_active_font" name="sub_active_font" value="<?php echo $rows->sub_active_font; ?>"/>
                                                <a onMouseOver="this.style.cursor='pointer'" onClick="document.getElementById('sub_active_font').color.showPicker()"><img src="components/com_swmenupro/images/sel.gif"/><?php echo _SW_GET; ?></a></div></td>
                                    </tr>
                                    <tr class="swmenu_menubackgr">
                                        <td  colspan="2"><?php echo _SW_TOP_MENU; ?>:</td>
                                        <td>  <div style="float:right;" >
                                    ...
                                    <tr class="swmenu_menubackgr">
                                        ...
                                        <td>
                                            <div style="float:right;" >
                                                <div id="levelx_sub_font_color_box" style="border: 1px solid #000000; width:20px; height:28px;float:left;margin-right:10px;" bgColor='<?php echo $rows->levelx_sub_font_color; ?>'>
                                                </div>
                                                <input name="levelx_sub_font_color" type="text" onchange="doFontColor(this);" id="levelx_sub_font_color" value="<?php echo $rows->levelx_sub_font_color; ?>" size="8" class="color {styleElement:'levelx_sub_font_color_box',hash:true,required:false,pickerOnfocus:false,pickerClosable:true}"/>
                                                <a onMouseOver="this.style.cursor='pointer'" onClick="document.getElementById('levelx_sub_font_color').color.showPicker()"><img src="components/com_swmenupro/images/sel.gif"/><?php echo _SW_GET; ?></a></div></td>
                                    </tr><tr>
                                        <td  colspan="2"><?php echo _SW_LEVEL." X " . _SW_HOVER; ?>:</td>
                                        <td>
                                            <div style="float:right;" >
                                                <div id="levelx_sub_font_color_over_box" style="border: 1px solid #000000; width:20px; height:28px;float:left;margin-right:10px;" bgColor='<?php echo $rows->levelx_sub_font_color_over; ?>'>
                                                </div>
                                                <input name="levelx_sub_font_color_over" type="text" onchange="doFontColor(this);" id="levelx_sub_font_color_over" value="<?php echo $rows->levelx_sub_font_color_over; ?>"  size="8" class="color {styleElement:'levelx_sub_font_color_over_box',hash:true,required:false,pickerOnfocus:false,pickerClosable:true}"/>
                                                <a onMouseOver="this.style.cursor='pointer'" onClick="document.getElementById('levelx_sub_font_color_over').color.showPicker()"><img src="components/com_swmenupro/images/sel.gif"/><?php echo _SW_GET; ?></a></div></td>
                                    </tr>
                           ...
                           <td width="50%" valign="top" align="center">
                                <table class="sw_table_right" >
                                    <tr>
                                        ...
                                        <td>
                                            <div align="right">
                                                <input id="sub_font_size" onchange="jQuery('.sub_preview.level1').css('font-size',this.value+'px');" name="sub_font_size" type="text" value="<?php echo $rows->sub_font_size; ?>" size="3" /> px
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="swmenu_menubackgr">
              ...
              <td>
                <div align="right">
                  <input id="levelx_sub_font_size" onchange="jQuery('.sub_preview.levelx').css('font-size',this.value+'px');" name="levelx_sub_font_size" type="text" value="<?php echo $rows->levelx_sub_font_size;?>" size="3" /> px
                </div>
              </td>
            </tr><tr>
                                    ...
                                    <tr class="swmenu_menubackgr">
                                        <td><?php echo _SW_LEVEL." X "; ?>:</td>
                                        <td><div align="right"><?php echo $lists['levelx_sub_font_weight']; ?></div></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo _SW_LEVEL." X "; ?>:</td>
                                        <td><div align="right"><?php echo $lists['levelx_sub_font_align']; ?></div></td>
                                    </tr><tr>
                                        <td colspan="2" class="swmenu_tabheading">
                                        ...
                                        <td><?php echo _SW_LEVEL." X "; ?>:</td>
                                        <td><div align="right"><?php echo $lists['levelx_sub_font_wrap']; ?></div></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="swmenu_tabheading">
                                    ...
                                    <tr class="swmenu_menubackgr">
                                        <td><?php echo _SW_LEVEL." X "; ?>:</td>
                                        <td><div align="right"><?php echo $lists['levelx_sub_font_extra']; ?></div></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td width="50%" valign="top" align="center">
                                <table class="sw_table_left" >
                                   <tr>
                                        ...
                                        <td >
                                        <div style="float:right;">
                                                <div id="main_border_color_box" style="float:left;margin-right:3px;margin-left:3px;border: 1px solid #000000; width:20px; height:18px" bgColor='<?php echo $rows->main_border_color; ?>'>
                                    ...
                                    <tr>
                                        ...
                                        <td><div style="float:right;">
                                                <div id="main_border_color_over_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:18px" bgColor='<?php echo $rows->main_border_color_over; ?>'>
                                   ...
                                   <td colspan="3" class="swmenu_tabheading"><div align="center"><?php echo _SW_SUB_MENU." "._SW_BORDER; ?></div></td>
                                    <tr class="swmenu_menubackgr">
                                        ...
                                        <td><div style="float:right;">
                                                <div id="sub_border_color_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:18px" bgColor='<?php echo $rows->sub_border_color; ?>'>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td><div style="float:right;">
                                                <div id="sub_border_color_over_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:18px" bgColor='<?php echo $rows->sub_border_color_over; ?>'>
                                                </div>
                                   ...
                                   <tr>  <td colspan="3" class="swmenu_tabheading"><div align="center"><?php echo _SW_LEVELX." "._SW_BORDER; ?></div></td></tr>
                                    <tr class="swmenu_menubackgr">
                                        <td><b><?php echo _SW_OUTSIDE." "._SW_BORDER_STYLE; ?>:</b></td>
                                        <td align="right"><?php echo $lists['levelx_outside_border_style']; ?></td>
                                        <td><div style="float:right;">
                                                <div id="levelx_outside_border_color_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:18px" bgColor='<?php echo $rows->levelx_border_color; ?>'>
                                                </div>
                                                <input  name="levelx_outside_border_color" type="text" onChange="doLevelxBorder();" id="levelx_outside_border_color" value="<?php echo $rows->levelx_outside_border_color; ?>" size="7" class="color {styleElement:'levelx_outside_border_color_box',hash:true,required:false,pickerOnfocus:false,pickerClosable:true}"/>
                                                <a onMouseOver="this.style.cursor='pointer'" onClick="document.getElementById('levelx_outside_border_color').color.showPicker()"><img src="components/com_swmenupro/images/sel.gif"/><?php echo _SW_GET; ?></a></div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="swmenu_menubackgr">
                                        <td><?php echo _SW_BORDER_WIDTH; ?>:</td>
                                        <td colspan="2" align="right">
                                            <input id="levelx_outside_border_width" onchange="doLevelxBorder();" name="levelx_outside_border_width" type="text" value="<?php echo $rows->levelx_outside_border_width; ?>" size="3" /> px
                                     ...
                                     <tr class="swmenu_menubackgr">
                                        <td colspan="3" align="center">
                                             <table>
                                                <tr>
                                                    <td width="90" align="center"><?php echo _SW_TOP." ".$lists['xot_border']; ?></td>
                                                    <td width="90" align="center"><?php echo _SW_RIGHT." ".$lists['xor_border']; ?></td>
                                                    <td width="90" align="center"><?php echo _SW_BOTTOM." ".$lists['xob_border']; ?></td>
                                                    <td width="90" align="center"><?php echo _SW_LEFT." ".$lists['xol_border']; ?></td>
                                                </tr> 
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td ><b><?php echo _SW_INSIDE." "._SW_BORDER_STYLE; ?>:</b></td>
                                        <td align="right"><?php echo $lists['levelx_inside_border_style']; ?></td>
                                        <td><div style="float:right;">
                                                <div id="levelx_inside_border_color_box" style="float:left;margin-right:10px;border: 1px solid #000000; width:20px; height:18px" bgColor='<?php echo $rows->levelx_inside_border_color; ?>'>
                                                </div>
                                                <input  name="levelx_inside_border_color" type="text" onChange="doLevelxBorder();" id="levelx_inside_border_color" value="<?php echo $rows->levelx_inside_border_color; ?>" size="7" class="color {styleElement:'levelx_inside_border_color_box',hash:true,required:false,pickerOnfocus:false,pickerClosable:true}"/>
                                                <a onMouseOver="this.style.cursor='pointer'" onClick="document.getElementById('levelx_inside_border_color').color.showPicker()"><img src="components/com_swmenupro/images/sel.gif"/><?php echo _SW_GET; ?></a></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><?php echo _SW_BORDER_WIDTH; ?>:</td>
                                        <td colspan="2" align="right">
                                            <input id="levelx_inside_border_width" onchange="doLevelxBorder();" name="levelx_inside_border_width" type="text" value="<?php echo $rows->levelx_inside_border_width; ?>" size="3" /> px
                                    ...
                                    <tr>
                                        <td colspan="3" align="center">
                                           <table>
                                                <tr>
                                                    <td width="70" align="center"><?php echo _SW_TOP." ".$lists['xit_border']; ?></td>
                                                    <td width="70" align="center"><?php echo _SW_RIGHT." ".$lists['xir_border']; ?></td>
                                                    <td width="70" align="center"><?php echo _SW_BOTTOM." ".$lists['xib_border']; ?></td>
                                                    <td width="70" align="center"><?php echo _SW_LEFT." ".$lists['xil_border']; ?></td>
                                                    <td width="70" align="center"><?php echo _SW_AUTO." ".$lists['x_auto_border']; ?></td>
                                                </tr> 
                                            </table>
                                        </td>
                                    </tr>
        ...
        <?php echo $lists['si_corner_size']; ?> px
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td colspan="2" class="swmenu_tabheading"><div align="center"><?php echo _SW_LEVELX." "._SW_CORNER; ?></div></td>
                                    </tr>
        ...
        <?php echo $lists['x_corner_style']; ?>
                                      ...
                                      <tr class="swmenu_menubackgr">
                                        <td><?php echo _SW_CORNER_SIZE; ?>:</td>
                                        <td align="right">
        <?php echo $lists['x_corner_size']; ?> px
                                   ...
                                   <tr class="swmenu_menubackgr">
                                        <td colspan="2" align="center">
                                          <table>
                                                <tr>
                                                    <td width="90" align="center"><?php echo _SW_CORNER_TOP_LEFT. " ".$lists['xtl_corner']; ?></td>
                                                    <td width="90" align="center"><?php echo _SW_CORNER_TOP_RIGHT. " ".$lists['xtr_corner']; ?></td>
                                                    <td width="90" align="center"><?php echo _SW_CORNER_BOTTOM_LEFT. " ".$lists['xbl_corner']; ?></td>
                                                    <td width="90" align="center"><?php echo _SW_CORNER_BOTTOM_RIGHT. " ".$lists['xbr_corner']; ?></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><b><?php echo _SW_INSIDE." "._SW_CORNER_STYLE; ?>:</b></td>
                                        <td align="right">
        <?php echo $lists['xi_corner_style']; ?>
                                    ...
                                    <tr>
                                        <td><?php echo _SW_CORNER_SIZE; ?>:</td>
                                        <td align="right">
        <?php echo $lists['xi_corner_size']; ?> px
                                    ...
                                    <tr>
                                        <td colspan="2" align="center">
                                           <table>
                                                <tr>
                                                    <td width="90" align="center"><?php echo _SW_CORNER_TOP_LEFT. " ".$lists['xitl_corner']; ?></td>
                                                    <td width="90" align="center"><?php echo _SW_CORNER_TOP_RIGHT. " ".$lists['xitr_corner']; ?></td>
                                                    <td width="90" align="center"><?php echo _SW_CORNER_BOTTOM_LEFT. " ".$lists['xibl_corner']; ?></td>
                                                    <td width="90" align="center"><?php echo _SW_CORNER_BOTTOM_RIGHT. " ".$lists['xibr_corner']; ?></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
       ...
       <?php 
                              ...
                              if ($rows->menustyle=="accordtransmenu"){
       ...
       <tr class="swmenu_menubackgr">
        ...
        <tr>
          ...
          <td valign="top"><?php echo "level1 Open(sticky)"; ?>:</td>
          <td><a href="javascript:void(0);" onmouseover="return escape('<?php echo _SW_EXPAND_ALL_TIP; ?>')" >
	      <img src="components/com_swmenupro/images/info.png" alt="info" align="middle"  border="0" /></a>
          <?php echo $lists['level1_open']; ?> </td>
        </tr>
        <tr>
          <td valign="top"><?php echo  "Level1 Revert to Default"; ?>:</td>
          <td><a href="javascript:void(0);" onmouseover="return escape('<?php echo _SW_AUTO_CLOSE_TIP; ?>')" >
	      <img src="components/com_swmenupro/images/info.png" alt="info" align="middle" name="info" border="0" /></a>
	      <?php echo $lists['revert2default']; ?> </td>
        </tr>
        <tr  class="swmenu_menubackgr">
          <td valign="top"><?php echo  "Level1 Fill Empty Submenu"; ?>:</td>
          <td><a href="javascript:void(0);" onmouseover="return escape('<?php echo _SW_AUTO_CLOSE_TIP; ?>')" >
	      <img src="components/com_swmenupro/images/info.png" alt="info" align="middle" name="info" border="0" /></a>
	      <?php echo $lists['level1_fillempty']; ?> </td>
        </tr>
         <tr>
                                        <td valign="top"><?php echo _SW_FLASH_HACK; ?>:</td>
                                        <td><a href="javascript:void(0);" onmouseover="return escape('<?php echo _SW_FLASH_HACK_TIP; ?>')" >
...
?>
                ...
                <input type="hidden" name="sub_font_face" id="sub_font_face" value="<?php echo @$rows->sub_font_face; ?>">
                 <input type="hidden" name="levelx_sub_font_face" id="levelx_sub_font_face" value="<?php echo @$rows->levelx_sub_font_face; ?>">
                ...
                <div id="preview_pane">
                    ...
                    <table cellspacing="0" cellpadding="0" class="preview_header">
                        <tr>
        ...
        <?php
        if ($rows->menustyle == "accordtransmenu") {
           HTML_swmenupro::accordTransPreview();
        } else if ($rows->menustyle == "multitabmenu"){
           
            HTML_swmenupro::multiTabPreview();
            
            }elseif (substr($rows->orientation, 0, 10) == "horizontal") {
            ?>
                        <div id="preview_div">
                           ...
                           <table border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>
                                                    <div id="sub_preview_parent" ><div  id="sub_preview_outer">
                                                             ...
                                                             <td valign="top"><a class="sub_preview level1 first normal" id="sub_preview_normal"  ><?php echo _SW_SUB_MENU_ITEM; ?></a></td>
                                                             <td valign="top"><a class="sub_preview level1 hover" id="sub_preview_hover"><?php echo _SW_SUB_MENU_ITEM . " " . _SW_HOVER; ?></a></td>
                                                             <td valign="top"><a class="sub_preview level1 last normal" id="sub_preview_normal2"><?php echo _SW_SUB_MENU_ITEM; ?></a></td>
                                                             </tr><tr class="levelx_outer">
                                                             <td valign="top" class="levelx_outer first">
                                                             <a class="sub_preview levelx normal first" id="sub_preview_hover"><?php echo _SW_LEVELX ; ?></a>
                                                             <a class="sub_preview levelx normal " id="sub_preview_hover"><?php echo _SW_LEVELX ; ?></a>
                                                             <a class="sub_preview levelx normal" id="sub_preview_hover"><?php echo _SW_LEVELX ; ?></a>
                                                             <a class="sub_preview levelx normal last" id="sub_preview_hover"><?php echo _SW_LEVELX ; ?></a>
                                                             </td>
                                                            <td valign="top" class="levelx_outer">
                                                             <a class="sub_preview levelx normal first" id="sub_preview_hover"><?php echo _SW_LEVELX ; ?></a>
                                                             <a class="sub_preview levelx hover" id="sub_preview_hover"><?php echo _SW_LEVELX . " " . _SW_HOVER; ?></a>
                                                            
                                                             <a class="sub_preview levelx normal last" id="sub_preview_hover"><?php echo _SW_LEVELX ; ?></a></td>
                                                           <td valign="top" class="levelx_outer last">
                                                             <a class="sub_preview levelx normal first" id="sub_preview_hover"><?php echo _SW_LEVELX ; ?></a>
                                                             <a class="sub_preview levelx normal last" id="sub_preview_hover"><?php echo _SW_LEVELX ; ?></a></td>
...
jQuery('#font_family').jec();
             jQuery('#sub_font_family').jec();
              jQuery('#levelx_sub_font_family').jec();
