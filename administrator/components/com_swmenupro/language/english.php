...
define( '_SW_EXPAND_ALL', 'Expand All Submenus' );
define( '_SW_EXPAND_ALL_TIP', 'Expand all submenus by default when the page loads.' );

define( '_SW_DISABLE_PARENT_LINKS', 'Disable Parent Item Links' );
...
define( '_SW_CORNER_TOP_LEFT', 'Top Left' );
define( '_SW_CORNER_TOP_RIGHT', 'Top Right' );
define( '_SW_CORNER_BOTTOM_LEFT', 'Bottom Left' );
define( '_SW_CORNER_BOTTOM_RIGHT', 'Bottom Right' );
...
define( '_SW_COMPLETE_BACKGROUND_IMAGE', 'Complete Background Image' );
...
define( '_SW_ACCORDIAN_MENU', 'Accordion Menu' );
...
define( '_SW_AUTO_CLOSE_LABEL', 'Auto Close Submenus' );
