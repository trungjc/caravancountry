...
// Model Class
class MijosefModelSefUrlsDp extends MijosefModel {
	...
	function getToolbarSelections() {
		...
		$toolbar->action = JHTML::_('select.genericlist', $act, 'sefurlsdp_action', 'class="inputbox" style="width: 120px;" size="1"');
        ...
        $toolbar->selection = JHTML::_('select.genericlist', $sel, 'sefurlsdp_selection', 'class="inputbox" style="width: 120px;" size="1"');
	...
	function getLists() {
        ...
        $lists['lang_list'] = JHTML::_('select.genericlist', $lang_list, 'filter_lang', 'class="inputbox" size="1" style="width: 155px;"'.$javascript, 'value', 'text', $this->filter_lang);
		
		// Search Real URL
        $lists['search_real'] = "<input type=\"text\" name=\"search_real\" value=\"{$this->search_real}\" size=\"45\" style=\"width: 180px;\" maxlength=\"255\" onchange=\"document.adminForm.submit();\" />";
		...
		// Search hits
        $lists['search_hits'] = "<input type=\"text\" name=\"search_hits\" value=\"{$this->search_hits}\" size=\"3\" style=\"width: 30px;\" maxlength=\"10\" onchange=\"document.adminForm.submit();\" />";
