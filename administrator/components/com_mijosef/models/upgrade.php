...
class MijosefModelUpgrade extends MijosefModel {
    ...
    public function upgrade() {
        ...
        $file = '';
        if (JFile::exists($package['dir'].'/com_mijosef_j3_basic.zip')) {
            $file = $package['dir'].'/com_mijosef_j3_basic.zip';
        }
        else if (JFile::exists($package['dir'].'/com_mijosef_j3_plus.zip')) {
            $file = $package['dir'].'/com_mijosef_j3_plus.zip';
        }
        else if (JFile::exists($package['dir'].'/com_mijosef_j3_pro.zip')) {
            $file = $package['dir'].'/com_mijosef_j3_pro.zip';
        }
        else if (JFile::exists($package['dir'].'/com_mijosef_j3_vip.zip')) {
            $file = $package['dir'].'/com_mijosef_j3_vip.zip';
        }
