...
class MijoSEF_com_newsfeeds extends MijosefExtension {
    ...
    function getCategoryList($query) {
        if (self::_is16()) {
         ...
         $rows = MijoDatabase::loadObjectList("SELECT id, title AS name FROM #__categories WHERE {$field} = 'com_newsfeeds' ORDER BY title");
