	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
			...
			<th>		
				<?php
					...
					if (!$status['htaccess'] || !$status['mod_rewrite'] || !$status['sef']) {
						JError::raiseNotice('100', JText::sprintf('COM_MIJOSEF_CPANEL_STATUS_NOTE_REQUIREMENTS', '<a href="http://mijosoft.com/support/docs/mijosef/installation-upgrading/requirements" target="_blank">', '</a>'));
					}
		...
		<tr>
					...
					<tr>
						<td>
							...
							if ($this->MijosefConfig->ui_cpanel == 1) {
								...
								$this->mijosefButton($link, 'icon-48-purgeupdate.png', JText::_('COM_MIJOSEF_COMMON_PURGEUPDATE'), true, 560, 320);
								...
								$link = 'http://mijosoft.com/joomla-extensions/mijosef/changelog?tmpl=component';
			...
			<td valign="top" width="42%" style="padding: 7px 0 0 5px">
							...
							<table class="adminlist table table-striped">
								...
								<tr height="70">
									...
									<td align="center" style="vertical-align: middle;" rowspan="<?php echo $rowspan; ?>">
										<a href="http://mijosoft.com/joomla-extensions/mijosef">
										<img src="components/com_mijosef/assets/images/logo.png" width="140" height="140" style="display: block; margin: auto;" alt="MijoSEF" title="MijoSEF" align="middle" border="0">
										</a>
									</td>
								</tr>
								<?php if ($pid) { ?>
									...
									<td>
										<?php
											if ($this->info['version_enabled'] == 0) {
                                                ...
                                                echo '<input type="button" class="btn btn-danger" value="'.JText::_('COM_MIJOSEF_COMMON_UPGRADE').'" onclick="upgrade();" />';
											} else {
								...
								<tr height="40">
									...
									<td>
										<a href="http://mijosoft.com" target="_blank"><?php echo Mijosef::get('utility')->getXmlText(JPATH_MIJOSEF_ADMIN.'/a_mijosef.xml', 'copyright'); ?></a>
									</td>
								</tr>
							</table>
						</td>
                ...
                <?php echo JHtml::_('sliders.panel', JText::_('COM_MIJOSEF_CPANEL_STATUS'), 'sefstatus'); ?>
				<table class="adminlist table table-striped">
					<thead>
						<tr>
							<td class="title">
