...
<table align="center" width="600">
	<tr>
		...
		<td class="column-css">
            <a href="http://mijosoft.com/support/docs/mijosef" target="_blank"><img src="http://mijosoft.com/images/support/documentation.png" class="image-css" /></a>
            <br />
            <div style="text-align: center;"><a href="http://mijosoft.com/support/docs/mijosef" target="_blank"><strong>Documentation</strong></a></div>
		</td>
		<td class="column-css">
            <a href="http://mijosoft.com/support/docs/mijosef/video-tutorials" target="_blank"><img src="http://mijosoft.com/images/support/videos.png" class="image-css" /></a>
            <br />
            <div style="text-align: center;"><a href="http://mijosoft.com/support/docs/mijosef/video-tutorials" target="_blank"><strong>Video Tutorials (VIP)</strong></a></div>
		</td>
	</tr>
	<tr>
		<td class="column-css">
