	...
	<fieldset class="adminform" style="background: #ffffff;">
		...
		<table class="admintable">
			...
			<tr>
				...
				<td class="value2">
					<textarea class="text_area" name="description" rows="5" style="width: 300px;" cols="57"><?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->row->description), true); ?></textarea>
				</td>
			</tr>
			<tr>
				<td class="key2">
				...
				<td class="value2">
					<textarea class="text_area" name="keywords" rows="3" cols="57" style="width: 300px;"><?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->row->keywords), true); ?></textarea>
				</td>
			</tr>
			<tr>
				<td class="key2">
				...
				<td class="value2">
					<input class="inputbox" type="text" name="lang" size="30" style="width: 100px;" value="<?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->row->lang), true); ?>" />
				</td>
			</tr>
			<tr>
				<td class="key2">
				...
				<td class="value2">
					<input class="inputbox" type="text" name="robots" size="30" style="width: 100px;" value="<?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->row->robots), true); ?>" />
				</td>
			</tr>
			<tr>
				<td class="key2">
				...
				<td class="value2">
					<input class="inputbox" type="text" name="googlebot" size="30" style="width: 100px;" value="<?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->row->googlebot), true); ?>" />
				</td>
			</tr>
			<tr>
				<td class="key2">
