...
?>
<form action="index.php?option=com_mijosef&amp;controller=purgeupdate&amp;task=view&amp;tmpl=component" name="adminForm" id="adminForm" method="post">
	<table class="noshow">
		<tr>
			<td width="50%">
				<fieldset>
					<legend><?php echo JText::_('COM_MIJOSEF_COMMON_URLS'); ?></legend>
					<table>
						<tr>
						...
						<tr>
							...
							<td width="75%" height="20">
								<label>
									<?php echo JText::_('COM_MIJOSEF_COMMON_URLS_CUSTOM'); ?>
								</label>
							</td>
							<td width="20%" height="20">
								<label>
						...
						<tr>
							...
							<td width="75%" height="20">
								<label>
									<?php echo JText::_('COM_MIJOSEF_COMMON_URLS_404'); ?>
								</label>
							</td>
							<td width="20%" height="20">
								<label>
						...
						<tr>
							...
							<td width="75%" height="20">
								<label>
									<?php echo JText::_('COM_MIJOSEF_COMMON_URLS_LOCKED'); ?>
								</label>
							</td>
							<td width="20%" height="20">
								<label>
						...
						<tr>
							...
							<td width="75%" height="20">
								<label>
									<?php echo JText::_('COM_MIJOSEF_COMMON_URLS_TRASHED'); ?>
								</label>
							</td>
					...
					<?php if ($this->urls['total'] != 0) { ?>
						<input type="submit" class="btn btn-danger" name="deleteurls" onclick="window.top.setTimeout('SqueezeBox.close();', 1000);" value="<?php echo JText::_('Delete'); ?>" />
						<input type="submit" class="btn btn-danger" name="updateurls" value="<?php echo JText::_('COM_MIJOSEF_TOOLBAR_UPDATE'); ?>" />
					<?php } ?>
				</fieldset>
			</td>
			<td width="50%">
				<fieldset height="350">
					<legend><?php echo JText::_('COM_MIJOSEF_PURGE_UPDATE_METADATA'); ?></legend>
					<table>
						<tr>
							<td width="5%" height="20">
								&nbsp;
					...
					<?php if ($this->meta['total'] != 0) { ?>
						<input type="submit" class="btn btn-danger" name="deletemeta" onclick="window.top.setTimeout('SqueezeBox.close();', 1000);" value="<?php echo JText::_('Delete'); ?>" />
						<input type="submit" class="btn btn-danger" name="updatemeta" value="<?php echo JText::_('COM_MIJOSEF_TOOLBAR_UPDATE'); ?>" />
					<?php } ?>
				</fieldset>
			</td>
		</tr>
