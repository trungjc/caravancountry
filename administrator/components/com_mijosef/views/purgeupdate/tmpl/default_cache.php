...
<form action="index.php?option=com_mijosef&amp;controller=purgeupdate&amp;task=cache&amp;tmpl=component" name="adminForm" method="post">
	<fieldset>
		...
		<input type="submit" class="btn btn-danger" name="cleancache" onclick="window.top.setTimeout('SqueezeBox.close();', 1500);" value="<?php echo JText::_('COM_MIJOSEF_CACHE_CLEAN'); ?>" />
	</fieldset>
