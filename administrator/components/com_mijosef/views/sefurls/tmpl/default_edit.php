...
<form action="index.php?option=com_mijosef&amp;controller=sefurls&amp;task=edit&cid[]=<?php echo $this->row->id; ?>&amp;tmpl=component" method="post" name="adminForm" id="adminForm">
	<?php if ($tmpl == 'component') { ?>
	<div>
			...
			<table class="toolbar1">
				<tr>
					<td class="desc" width="550px">
						<?php
							$text = JText::_('COM_MIJOSEF_URL_EDIT_NEW');
							if ($task != 'add') {
								$text = '<u>'.JText::_('COM_MIJOSEF_URL_EDIT_TITLE').'</u> '.$this->row->url_sef; 
							}
    ...
    <?php } ?>
    <?php echo JHtml::_('tabs.start', 'url', array('startOffset' => $startOffset)); ?>
    ...
    <?php echo JHtml::_('tabs.panel', JText::_('COM_MIJOSEF_COMMON_URL'), 'url'); ?>
		<table class="admintable">
			<tr>
				...
				<td class="editform_td2">
					<input class="inputbox" type="text" name="url_sef" size="80" style="width: 400px" value="<?php echo $this->row->url_sef; ?>" />
				</td>
			</tr>
			<tr>
				<td width="23%" class="key2">
					<label>
						<?php echo JText::_('COM_MIJOSEF_URL_SEF_COMMON_URL_REAL'); ?>
					</label>
				</td>
				<td class="editform_td2">
					<input class="inputbox" type="text" id="url_real" name="url_real" size="80" style="width: 400px" value="<?php echo $this->row->url_real; ?>" />
				</td>
			</tr>
			<tr>
				<td width="23%" class="key2">
                    ...
                    <table class="noshow">
                        <tr>
                            <td>
                                ...
                                &nbsp;<?php echo JText::_('COM_MIJOSEF_URL_EDIT_CUSTOM'); ?>
                            </td>
                            <td>
			...
			<tr>
				<td width="23%" class="key2">
					<label>
						<?php echo JText::_('COM_MIJOSEF_URL_EDIT_ALIAS'); ?>
					</label>
				</td>
				<td class="editform_td2">
					<textarea name="url_alias" rows="8" cols="57" style="width: 400px" class="text_area"><?php echo $this->url['alias']; ?></textarea>
				</td>
			</tr>
			<tr>
				<td width="23%" class="key2">
					<label>
						<?php echo JText::_('COM_MIJOSEF_URL_EDIT_NOTES'); ?>
					</label>
				</td>
				<td class="editform_td2">
					<textarea name="url_notes" rows="3" cols="57" style="width: 400px" class="text_area"><?php echo Mijosef::get('utility')->replaceSpecialChars($this->url['notes'], true); ?></textarea>
				</td>
			</tr>
		</table>

    <?php echo JHtml::_('tabs.panel', JText::_('COM_MIJOSEF_COMMON_METADATA'), 'meta'); ?>
		<table class="admintable">
			<tr>
				<td width="23%" class="key2">
					<label>
			...
			<tr>
				...
				<td class="editform_td2">
					<input class="inputbox" type="text" name="meta_title" size="80" style="width: 400px" value="<?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->metadata->title), true); ?>" />
			...
			<tr>
				...
				<td class="editform_td2">
					<textarea name="meta_desc" rows="4" cols="57" style="width: 400px" class="text_area"><?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->metadata->description), true); ?></textarea>
				</td>
			</tr>
			<tr>
				<td width="23%" class="key2">
				...
				<td class="editform_td2">
					<textarea name="meta_key" rows="2" cols="57" style="width: 400px" class="text_area"><?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->metadata->keywords), true); ?></textarea>
				</td>
			</tr>
			<tr>
				<td width="23%" class="key2">
				...
				<td class="editform_td2">
					<input class="inputbox" type="text" name="meta_lang" size="30" value="<?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->metadata->lang), true); ?>" />
				</td>
			</tr>
			<tr>
				<td width="23%" class="key2">
				...
				<td class="editform_td2">
					<input class="inputbox" type="text" name="meta_robots" size="30" value="<?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->metadata->robots), true); ?>" />
				</td>
			</tr>
			<tr>
				<td width="23%" class="key2">
				...
				<td class="editform_td2">
					<input class="inputbox" type="text" name="meta_googlebot" size="30" value="<?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->metadata->googlebot), true); ?>" />
				</td>
			</tr>
			<tr>
				<td width="23%" class="key2">
				...
				<td class="editform_td2">
					<input class="inputbox" type="text" name="meta_canonical" size="80" value="<?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->metadata->canonical), true); ?>" />
				</td>
			</tr>
		</table>
    ...
    <?php echo JHtml::_('tabs.panel', JText::_('COM_MIJOSEF_COMMON_SITEMAP'), 'sitemap'); ?>
		<table class="admintable">
			...
			<tr>
				...
				<td class="editform_td2">
					<?php echo JHTML::_('select.genericlist', Mijosef::get('sitemap')->getFrequencyList(), 'sm_freq', 'class="inputbox" size="1 "','value', 'text', $this->sitemap->frequency); ?>
				</td>
			</tr>
			<tr>
				<td width="23%" class="key2">
				...
				<td class="editform_td2">
					<?php echo JHTML::_('select.genericlist', Mijosef::get('sitemap')->getPriorityList(), 'sm_priority', 'class="inputbox" size="1 "','value', 'text', $this->sitemap->priority); ?>
				</td>
			</tr>
		</table>
    ...
    <?php echo JHtml::_('tabs.panel', JText::_('COM_MIJOSEF_URL_EDIT_TABS_SOURCE'), 'source'); ?>
		<?php
		if ($this->row->source) {
			$source = explode('--b1--', Mijosef::get('utility')->replaceSpecialChars($this->row->source, true));
			...
			for ($i=0; $i < 3; $i++) {
				...
				?>
				<fieldset class="adminform">
				<legend><?php echo JText::_('COM_MIJOSEF_URL_EDIT_LEGEND_SOURCE').' '.$no; ?></legend>
					<table class="admintable">
						<tr>
							<td width="23%" class="key2">
								<label>
									<?php echo JText::_('COM_MIJOSEF_URL_EDIT_SOURCE_FUNCTION'); ?>
								</label>
							</td>
							<td class="editform_td2">
								<?php echo $line[0]; ?>
						...
						<tr>
							<td width="23%" class="key2">
								<label>
									<?php echo JText::_('COM_MIJOSEF_URL_EDIT_SOURCE_FILE'); ?>
								</label>
							</td>
							<td class="editform_td2">
								<?php echo $line[1]; ?>
						...
						<tr>
							<td width="23%" class="key2">
								<label>
									<?php echo JText::_('COM_MIJOSEF_URL_EDIT_SOURCE_LINE'); ?>
								</label>
							</td>
							<td class="editform_td2">
								<?php echo $line[2]; ?>
