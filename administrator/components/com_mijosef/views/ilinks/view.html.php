...
class MijosefViewIlinks extends MijosefView {
	...
	function view($tpl = null) {
		...
		// Toolbar
		JToolBarHelper::title(JText::_('COM_MIJOSEF_COMMON_ILINKS' ), 'mijosef');
		$this->toolbar->appendButton('Popup', 'add', JText::_('New'), 'index.php?option=com_mijosef&controller=ilinks&task=add&tmpl=component', 600, 350);
		...
		JToolBarHelper::divider();
		$this->toolbar->appendButton('Popup', 'help', JText::_('Help'), 'http://mijosoft.com/support/docs/mijosef/user-manual/internal-links?tmpl=component', 650, 500);
