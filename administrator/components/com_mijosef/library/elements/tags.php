...
class JFormFieldTags extends JFormField {
	...
	protected function getInput() {
		...
		$html .= '<div class="button2-left"><div class="blank"><a class="btn btn-primary modal" title="'.JText::_('Select Tag').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 650, y: 375}}"><i class="icon-list icon-white"></i>'.JText::_('Select Tag').'</a></div></div>'."\n";
