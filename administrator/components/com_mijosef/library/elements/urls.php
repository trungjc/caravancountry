...
class JFormFieldURLs extends JFormField {
	...
	protected function getInput() {
		...
		$html .= '<div class="button2-left"><div class="blank"><a class="btn btn-primary modal" title="'.JText::_('Select URL').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 900, y: 500}}"><i class="icon-list icon-white"></i>'.JText::_('Select URL').'</a></div></div>'."\n";
