...
class MijosefMetadata {
	...
	function plugin($document) {
		...
		// Meta
		$url_id 		= MijoSef::get('utility')->get('mijosef.url.id');
		$url_sef 		= MijoSef::get('utility')->get('mijosef.url.sef');
		$auto_desc		= Mijosef::get('utility')->replaceSpecialChars(MijoSef::get('utility')->get('mijosef.meta.autodesc'), true);
		$auto_key		= Mijosef::get('utility')->replaceSpecialChars(MijoSef::get('utility')->get('mijosef.meta.autokey'), true);
		$meta_title		= Mijosef::get('utility')->replaceSpecialChars(MijoSef::get('utility')->get('mijosef.meta.title'), true);
		$meta_desc		= Mijosef::get('utility')->replaceSpecialChars(MijoSef::get('utility')->get('mijosef.meta.desc'), true);
		$meta_key		= Mijosef::get('utility')->replaceSpecialChars(MijoSef::get('utility')->get('mijosef.meta.key'), true);
		$meta_lang   	= MijoSef::get('utility')->get('mijosef.meta.lang');
		$meta_robots	= MijoSef::get('utility')->get('mijosef.meta.robots');
		$meta_google	= MijoSef::get('utility')->get('mijosef.meta.google');
		$link_canonical	= MijoSef::get('utility')->get('mijosef.link.canonical');
	...
	function _pluginDescKey($url_id, $org_val, $db_val, $auto_val, $type) {
		...
		if ($this->MijosefConfig->$AConfig == '1' || $this->MijosefConfig->$AConfig == '3') {
			...
			$global_val = JFactory::getConfig()->get($JConfig);
