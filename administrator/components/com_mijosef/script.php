...
class com_MijosefInstallerScript {
    ...
    public function preflight($type, $parent) {
        ...
        if (!empty($config)) {
            ...
            if (JFile::exists($mijosef_xml)) {
                $xml = simplexml_load_file($mijosef_xml);
	...
	public function postflight($type, $parent) {
		...
		if ($this->_is_new_installation == true) {
			$extensions = array('com_mijosef', 'com_banners', 'com_contact', 'com_content', 'com_mailto', 'com_newsfeeds', 'com_search', 'com_tags', 'com_users', 'com_weblinks', 'com_wrapper');
        ...
        $db->setQuery("UPDATE #__modules SET position = 'cpanel', ordering = '0', published = '1' WHERE module = 'mod_mijosef_quickicons'");
        $db->query();
