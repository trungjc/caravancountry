...
<div id="filter-bar" class="btn-toolbar">
	...
	<div class="btn-group twoj_float_right twoj_ml5 hidden-phone">
		<label for="limit" class="element-invisible"><?php echo JText::_('JFIELD_PLG_SEARCH_SEARCHLIMIT_DESC');?></label>
		<?php echo $this->pagination->getLimitBox(); ?>
	</div>
	<div class="btn-group twoj_float_right twoj_ml5">
		<select name="filter_state" class="input-medium inputbox" onchange="this.form.submit()">
