...
JFactory::getDocument()->addStyleSheet('components/com_mijosef/assets/css/mijosef.css');
	...
	<div class="icon-wrapper" style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
		<div class="icon">
			<a href="<?php echo $link; ?>">
                <img src="<?php echo JURI::root(true); ?>/administrator/components/com_mijosef/assets/images/<?php echo $image; ?>" alt="<?php echo $text; ?>" />
